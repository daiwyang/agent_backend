...
async def login(login_data: UserLoginRequest):
    ...
    access_token = await user_service.create_access_token(data={"sub": user["username"]}, expires_delta=access_token_expires)
    ...
    return UserLoginResponse(access_token=access_token, token_type="bearer", user=user_response)
